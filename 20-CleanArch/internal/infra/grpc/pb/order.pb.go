...
type ListedOrderResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListedOrderResponse) Reset() {
	*x = ListedOrderResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListedOrderResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListedOrderResponse) ProtoMessage() {}

func (x *ListedOrderResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protofiles_order_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListedOrderResponse.ProtoReflect.Descriptor instead.
func (*ListedOrderResponse) Descriptor() ([]byte, []int) {
	return file_protofiles_order_proto_rawDescGZIP(), []int{4}
}

func (x *ListedOrderResponse) GetOrders() []*OrderResponse {
	if x != nil {
		return x.Orders
	}
	return nil
...
var file_protofiles_order_proto_rawDesc = []byte{
	...
	0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x40, 0x0a,
	0x13, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	...
	0x12, 0x32, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x09,
	0x2e, 0x70, 0x62, 0x2e, 0x42, 0x6c, 0x61, 0x6e, 0x6b, 0x1a, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x4c,
	0x69, 0x73, 0x74, 0x65, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
var file_protofiles_order_proto_goTypes = []interface{}{
	...
	(*ListedOrderResponse)(nil), // 4: pb.ListedOrderResponse
}
var file_protofiles_order_proto_depIdxs = []int32{
	3, // 0: pb.ListedOrderResponse.orders:type_name -> pb.OrderResponse
	...
	4, // 4: pb.OrderService.ListOrders:output_type -> pb.ListedOrderResponse
...
func file_protofiles_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protofiles_order_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListedOrderResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
